...
export interface BaseUser {
  ...
  username: string
  /** This is an id specific to the authSource, for example for NOMIS users this is the staffId */
  userId: string | undefined
  /** This is a UUID created by HMPPS Auth upon first user login that is unique to the user across all authSources */
