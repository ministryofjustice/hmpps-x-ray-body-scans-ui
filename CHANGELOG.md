...
See PR [#742](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/742) and [#743](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/743)
...
See PR [#738](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/738)
...
See PR [#718](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/718)
...
See PR [#693](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/693)
...
See PR [#719](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/719)

**April 14th 2026** - Move to Typescript v6.

See PR [#715](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/715)

**April 13th 2026** - Fix renovate config for stability days.

Ensure renovate config matches npmrc config for stability days

See PR [#711](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/711)
...
See PR [#706](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/706)
...
See PR [#679](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/679)
...
See PR [#648](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/648)
...
See PR [#665](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/665)
...
See PR [#643](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/643)
...
See PR [#638](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/638)
...
See PR [#636](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/636)
...
See PR [#635](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/635)
...
See PR [#632](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/632)
...
See PR [#631](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/631)
...
hmpps-x-ray-body-scans-ui, we have enhanced the Application Insights integration to include both the username and
...
See PR [#629](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/629)

**November 21st 2025** - Fix ESBuild watch mode

Changes to nunjucks templates weren't triggering a rebuild - this fixes that.

See PR [#621](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/621)
...
See PR [#615](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/615)
...
See PR [#609](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/609)

**October 29th 2025** - Move to node 24

Node 24 is now LTS. Notes [here](https://nodejs.org/en/blog/release/v24.11.0)

See PR [#607](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/607)
...
See PR [#603](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/603)
...
See PR [#584](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/584)
...
See PR [#593](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/593)
...
See PR [#582](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/582)

**August 7th 2025** - Upgrading chokidar to v4 meant the paths needed changing.

See PR [#575](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/575)

See https://www.npmjs.com/package/chokidar#upgrading for details

**June 23rd 2025** - Moving to version 0.0.1 of shared libraries

See PR [#559](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/559)
...
See PR [#556](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/556)
...
For more details, see PR [#525](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/525),
...
See PR [#521](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/521)
...
See PR [#479](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/479)
...
See PR [#481](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/481)
...
See PR [#383](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/383)
...
See PR [#474](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/474)
...
See PR [#441](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/441)
...
See PR [#439](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/439)
...
See PR [#435](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/435)
...
PR: [#412](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/412) and
PR: [#414](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/414). We also updated the documentation
...
can be found in PR: [#413](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/413) and
PR: [#415](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/415).
...
PR: [#388](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/388) and PR: [#378](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/378)
...
PR: [#377](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/377)
...
PR: [#388](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/388)
...
PR: [#375](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/375)
...
PR: [#365](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/365)
...
PR: [#352](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/352)

---

**February 29th 2024** – Use same node version for outdated check and security scan. This currently defaults to node 16

PR: [#321](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/321)

---

**February 15th 2024** – Move over to use Debian 12 based image (bookworm)

PR: [#316](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/316)
...
PR: [#297](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/297)
...
PR: [#274](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/274)

---

**November 29th 2023** – Use in-memory token store when developing locally

PR: [#273](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/273)

---

**November 6th 2023** – Add HMPPS Manage Users API to health checks

PR: [#255](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/255)
...
PR: [#252](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/252)
...
PR: [#249](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/249)
...
PR: [#247](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/247)
...
PR: [#238](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/238)
...
PR: [here](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/231)
...
PR: [here](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/212)
...
PR: [here](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/197)
...
PR: [here](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/178)
...
PR: [here](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/172)
...
PR: [here](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/170)
...
PR: [here](https://github.com/ministryofjustice/hmpps-x-ray-body-scans-ui/pull/149)
